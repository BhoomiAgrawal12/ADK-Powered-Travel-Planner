...
async def execute(request):
    ...
    prompt = (
        f"Plan a trip from {request['origin']} to {request['destination']} from {request['start_date']} to {request['end_date']} "
        f"within a total budget of {request['budget']} Rs. Call the flights, stays, and activities agents for results."
    )
